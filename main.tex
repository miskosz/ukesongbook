...
\usepackage[nostamp]{draftwatermark}			% enable/disable: stamp/nostamp
...
\newcommand{\songbookversion}{v1.0.\today}
\SetWatermarkText{\songbookversion}
\SetWatermarkColor[gray]{0.6}
\SetWatermarkFontSize{0.3cm}
\SetWatermarkAngle{90}
\SetWatermarkHorCenter{0.4cm}
...
\begin{titlepage}
	\begin{center}
		...
		\LARGE ukulelespevnik.sk

		\vspace{2cm}

		\qrcode[hyperlink,height=3.5cm]{uke.sk}

		\vspace{2cm}

		\Large Verzia \songbookversion
