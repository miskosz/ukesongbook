...
Not a \ch{D}footprint to be seen \ch{Asus4-Am} \par
...
\ch{G}I don't \ch{\early D}care… what they're \ch{Em}going to \ch{\early C}say \par
Let the \ch{Bm}storm rage \ch{\early Bb}on… \par
The \ch{C\rep2 - single strum}cold never bothered me anyway \par
...
\ch{G}Here I \ch{\early D}stand, and \ch{Em}here I'll \ch{\early C}stay \par
Let the \ch{Bm}storm rage \ch{\early Bb}on \ch{C\rep2} \par
...
\ch{G}Here I \ch{\early D}stand, in the \ch{Em}light of \ch{\early C}day \par
\ch{Cm} Let the \ch{Bm}storm rage \ch{\early Bb\rep2}on \par
