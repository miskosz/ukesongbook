...
\ch{F\beats2}Ain't no \ch{Dm\beats2}mountain high \ch{\early G\beats2} enough \ch{\early Am\beats2} \par
\ch{F\beats2}Ain't no \ch{Dm\beats2}valley low \ch{\early G\beats2} enough \ch{\early Am\beats2} \par
\ch{F\beats2}Ain't no \ch{Dm\beats2}river wide \ch{\early G\beats2} enough \ch{\early Am\beats2} \par
\ch{F\beats2}Ain't no \ch{Dm\beats2}mountain high \ch{\early G\beats2} enough \ch{\early Am\beats2} \par
\ch{F\beats2}Ain't no \ch{Dm\beats2}valley low \ch{\early G\beats2} enough \ch{\early Am\beats2} \par
